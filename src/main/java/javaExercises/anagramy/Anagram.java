package javaExercises.anagramy;
...
public class Anagram {
    ...
    public List<String> wczytajPlik() throws Exception {
        ...
        BufferedReader bufferedReader = new BufferedReader(new FileReader("C:\\Users\\piotr\\eclipse-workspacenowaIntellij\\javaExercises\\anagramy\\anagram.txt"));
